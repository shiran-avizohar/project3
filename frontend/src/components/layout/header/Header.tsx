                        ...
                        <>
                            {user.role === 'admin' && (
                                <>
                                    ...
                                    <NavLink to="/admin/edit-vacation">Edit Vacation</NavLink>
                                    <NavLink to="/admin/csv-download">Download CSV</NavLink>
                                </>
                            )}
                            {user.role !== 'admin' && (
                                <>
                                    <NavLink to="/vacations/followed">Followed Vacations</NavLink>
