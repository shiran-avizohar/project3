...
//   const [newImage, setNewImage] = useState<File | null>(null); // State for new image file
...
//         const data = await response.json();
//         setVacation(data);
//         console.log("Fetched vacation:", data);
...
//     if (file) {
//       setNewImage(file); // Update state with the new image
//     }
//   };
...
//     formData.append("vacationDestination", vacation.vacationDestination);
//     formData.append("price", String(vacation.price));
//     formData.append("vacationDateStart", vacation.vacationDateStart);
//     formData.append("vacationDateEnd", vacation.vacationDateEnd);
//     formData.append("vacationDescription", vacation.vacationDescription);
//     if (newImage) {
//       formData.append("imgFileName", newImage); // Append new image if selected
//     }
